"""
RQ1 — Adversarial Robustness of CRNN Training Strategies.
...
Outputs saved to:
  research_answers/crnn/AtTraining_RQ1/

Usage
-----
  python scripts/crnn/rq1_adversarial_robustness.py
"""
...
def main():
    print("=" * 60)
    print("RQ1 — CRNN Adversarial Robustness Analysis")
    print("Strategies: Baseline | AT-FGSM | AT-BIM | AFT-FGSM | AFT-BIM")
    print("Attacks:    FGSM + BIM  |  eps = 0.01, 0.03, 0.10")
    print("=" * 60)

    out_dir = os.path.join(ROOT, "research_answers", "crnn", "AtTraining_RQ1")
